(() => {
    ...
    const CONTENT = {
        'zh-CN': {
            ...
            desktopSatellite: '卫星轨迹',
            desktopMail: '电子邮件',
            satelliteWindowTitle: '卫星轨迹 - 实时演示',
            satelliteTaskTitle: '卫星轨迹',
            satelliteMenuData: '数据',
            satelliteRefresh: '刷新数据',
            satelliteResetView: '重置地球视角',
            satelliteToggleOrbit: '显示 / 隐藏轨道',
            satelliteAbout: '关于卫星轨迹',
            satelliteSearchPlaceholder: '搜索卫星名称或 NORAD 编号',
            satelliteSearch: '查找',
            satelliteLoading: '正在载入 CelesTrak 轨道数据...',
            satelliteLoadError: '无法载入轨道数据，请稍后重试。',
            satelliteReady: '实时推算运行中',
            satelliteSource: 'CelesTrak OMM · satellite.js SGP4',
            satelliteCountLabel: '在轨卫星',
            satelliteTimeLabel: 'UTC 时间',
            satelliteSelectedTitle: '卫星信息',
            satelliteNoSelection: '搜索或点击一个光点查看卫星信息。',
            satelliteNoradLabel: 'NORAD',
            satelliteAltitudeLabel: '高度',
            satelliteSpeedLabel: '速度',
            satellitePositionLabel: '纬度 / 经度',
            satellitePeriodLabel: '轨道周期',
            satelliteInclinationLabel: '轨道倾角',
            satelliteAgeLabel: 'TLE 龄期',
            satelliteAgeUnit: '天',
            satelliteDetailNote: '实时位置与完整轨道线由 SGP4 在浏览器本地推算。',
            satelliteGroupsTitle: '星座分组',
            satelliteStarlink: '星链',
            satelliteOneweb: '一网',
            satelliteStations: '空间站',
            satelliteGps: 'GPS',
            satelliteBeidou: '北斗',
            satelliteGlonass: '格洛纳斯',
            satelliteGalileo: '伽利略',
            satelliteIridium: '铱星',
            satelliteWeather: '气象',
            satelliteOther: '其他',
            satelliteAboutStatus: '轨道数据来自 CelesTrak，位置由 satellite.js 在本地使用 SGP4 实时推算。',
            satelliteSearchEmpty: '没有找到匹配的卫星。',
            ...
            menuClose: '关闭',
            menuSelectAll: '全选',
            menuClearSelection: '取消选择',
            menuGoTop: '回到顶部',
            menuToggleWindowSize: '最大化 / 还原',
            menuGitHub: 'GitHub 主页',
            menuAboutGavin: '关于 Gavin',
            menuOpen: '打开',
            menuRefresh: '刷新',
            menuFolderInfo: '关于此文件夹',
            menuClearDraft: '清空草稿',
            menuSelectField: '全选当前字段',
            menuClearField: '清空当前字段',
            menuFocusName: '定位到姓名',
            menuFocusMessage: '定位到留言',
            menuDeliveryHelp: '发送说明',
            folderHelpStatus: '1 个文件夹，包含 13 张 RoboMaster 比赛照片。',
            mailStatusHelp: '填写姓名、邮箱与留言后发送；消息会转发至 Gavin 的邮箱。',
            addressLabel: '地址',
            addressGo: '转到',
            statusReady: '完成',
            statusZone: '我的电脑',
            ...
            taskbarAudioMute: '静音背景音乐',
            taskbarAudioUnmute: '取消背景音乐静音',
        ...
        en: {
            ...
            desktopSatellite: 'Satellite Tracker',
            desktopMail: 'E-mail',
            satelliteWindowTitle: 'Satellite Tracker - Live View',
            satelliteTaskTitle: 'Satellite Tracker',
            satelliteMenuData: 'Data',
            satelliteRefresh: 'Refresh Data',
            satelliteResetView: 'Reset Earth View',
            satelliteToggleOrbit: 'Show / Hide Orbit',
            satelliteAbout: 'About Satellite Tracker',
            satelliteSearchPlaceholder: 'Search by satellite name or NORAD ID',
            satelliteSearch: 'Find',
            satelliteLoading: 'Loading CelesTrak orbital data...',
            satelliteLoadError: 'Unable to load orbital data. Please try again later.',
            satelliteReady: 'Live propagation running',
            satelliteSource: 'CelesTrak OMM · satellite.js SGP4',
            satelliteCountLabel: 'Satellites',
            satelliteTimeLabel: 'UTC time',
            satelliteSelectedTitle: 'Satellite details',
            satelliteNoSelection: 'Search or click a point to inspect a satellite.',
            satelliteNoradLabel: 'NORAD',
            satelliteAltitudeLabel: 'Altitude',
            satelliteSpeedLabel: 'Speed',
            satellitePositionLabel: 'Latitude / longitude',
            satellitePeriodLabel: 'Orbital period',
            satelliteInclinationLabel: 'Inclination',
            satelliteAgeLabel: 'TLE age',
            satelliteAgeUnit: 'days',
            satelliteDetailNote: 'Live position and the full orbit path are propagated locally in the browser with SGP4.',
            satelliteGroupsTitle: 'Constellation groups',
            satelliteStarlink: 'Starlink',
            satelliteOneweb: 'OneWeb',
            satelliteStations: 'Stations',
            satelliteGps: 'GPS',
            satelliteBeidou: 'BeiDou',
            satelliteGlonass: 'GLONASS',
            satelliteGalileo: 'Galileo',
            satelliteIridium: 'Iridium',
            satelliteWeather: 'Weather',
            satelliteOther: 'Others',
            satelliteAboutStatus: 'Orbital data comes from CelesTrak; satellite.js propagates each position locally with SGP4.',
            satelliteSearchEmpty: 'No matching satellite was found.',
            ...
            menuGoTop: 'Back to Top',
            menuToggleWindowSize: 'Maximize / Restore',
            menuGitHub: 'GitHub Profile',
            menuAboutGavin: 'About Gavin',
            menuOpen: 'Open',
            menuRefresh: 'Refresh',
            menuFolderInfo: 'About This Folder',
            menuClearDraft: 'Clear Draft',
            menuSelectField: 'Select Current Field',
            menuClearField: 'Clear Current Field',
            menuFocusName: 'Go to Name',
            menuFocusMessage: 'Go to Message',
            menuDeliveryHelp: 'Sending Help',
            folderHelpStatus: '1 folder containing 13 RoboMaster match photos.',
            mailStatusHelp: 'Enter your name, e-mail and message; it will be forwarded to Gavin’s inbox.',
            ...
            taskbarAudioMute: 'Mute background music',
            taskbarAudioUnmute: 'Unmute background music',
            shutdownBrandName: 'Gavin,',
            shutdownBrandSubline: 'gavin inc.',
