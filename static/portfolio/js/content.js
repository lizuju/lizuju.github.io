(() => {
    ...
    const CONTENT = {
        'zh-CN': {
            ...
            desktopMail: '电子邮件',
            mailWindowTitle: '新建邮件',
            mailTaskTitle: '电子邮件',
            mailRecipientLabel: '收件人:',
            mailNameLabel: '* 姓名:',
            mailEmailLabel: '* 邮箱:',
            mailCompanyLabel: '公司（可选）:',
            mailMessageLabel: '* 留言:',
            mailNamePlaceholder: '你的姓名',
            mailEmailPlaceholder: '你的邮箱',
            mailCompanyPlaceholder: '公司或团队',
            mailMessagePlaceholder: '写下你的留言...',
            mailSend: '发送邮件',
            mailForwarding: '消息会转发至 Gavin 的邮箱。',
            mailStatusReady: '请填写信息后发送。',
            mailStatusSending: '正在发送...',
            mailStatusSuccess: '已发送，感谢你的留言。',
            mailStatusError: '发送失败，请稍后再试。',
            mailSubject: '来自作品集的新留言',
            folderWindowTitle: '项目文件 - 资源管理器',
            folderTaskTitle: '项目文件',
            folderAddress: 'C:\\GAVIN\\PROJECTS',
            folderAgent: 'AI Agent',
            folderVision: '计算机视觉',
            folderRobotics: '机器人系统',
            folderResearch: '研究文档',
            folderMedia: '图片资料',
            folderReadme: 'README.TXT',
            folderReadmeBody: '个人项目、研究与视觉素材归档。',
            folderStatus: '1 个对象',
            folderRoboMasterRecords: 'ROBOMASTER_RECORDS',
            folderRoboMasterRecordsBody: '13 张比赛照片',
            folderPhotoWindowTitle: 'ROBOMASTER_RECORDS - 资源管理器',
            folderPhotoAddress: 'C:\\GAVIN\\PROJECTS\\ROBOMASTER_RECORDS',
            folderPhotoStatus: '13 个对象',
            folderUp: '上一级',
            previewWindowTitle: '图片预览',
            previewTaskTitle: '图片预览',
            previewStatus: '选择一张图片进行预览',
            previewImageType: 'JPEG 图像',
            ...
            shutdownBrandName: 'Gavin,',
            shutdownBrandSubline: 'gavin inc.',
            shutdownRelease: 'GavinOS / 电源管理',
            shutdownReleaseVersion: '系统会话 1.0',
            shutdownKicker: '系统状态：安全关机',
            shutdownTitle: '系统已安全暂停',
            shutdownRestart: '重新启动',
            shutdownHint: '作品集内容保持在线。你可以立即重新启动，系统也会自动恢复。',
            shutdownLines: [
                '正在保存作品集会话...',
                '正在关闭个人主页窗口...',
                '作品集内容保持在线。',
            ...
            publicationsTitle: '正在推进的研究',
            paperOneVenue: 'AAAI 2027 · CCF-A · Submitted · 2026.06',
            paperOneRole: '共同第一作者 · Submission 3748',
            paperOneBody: '提出滞后鲁棒频谱图聚合框架，结合局部 Patch 表征、Top-k 稀疏自适应图聚合与频谱不确定性损失。',
            ...
            educationHighlights: ['两届国家奖学金', '励志榜样', '优秀毕业生', '校一等奖学金', '大学生年度人物', '学习先锋'],
            ...
            projects: [
                ...
                },
                {
                    ...
                    body: '把视觉检测、LIVO 定位建图与 Web 管理平台串成自动化盘点链路。',
                    alt: '仓储货架上的机器视觉与雷达盘点传感器',
                    details: [
            ...
            otherAwards: [
                ...
                '2026 TAAC 腾讯广告算法大赛第 114 名（Top 7%）',
        ...
        en: {
            ...
            desktopMail: 'E-mail',
            mailWindowTitle: 'New Message',
            mailTaskTitle: 'E-mail',
            mailRecipientLabel: 'To:',
            mailNameLabel: '* Your name:',
            mailEmailLabel: '* E-mail:',
            mailCompanyLabel: 'Company (optional):',
            mailMessageLabel: '* Message:',
            mailNamePlaceholder: 'Your name',
            mailEmailPlaceholder: 'Your e-mail address',
            mailCompanyPlaceholder: 'Company or team',
            mailMessagePlaceholder: 'Write your message...',
            mailSend: 'Send Message',
            mailForwarding: 'Messages are forwarded to Gavin’s inbox.',
            mailStatusReady: 'Complete the form to send a message.',
            mailStatusSending: 'Sending message...',
            mailStatusSuccess: 'Message sent. Thank you for reaching out.',
            mailStatusError: 'Unable to send right now. Please try again.',
            mailSubject: 'New message from portfolio',
            folderWindowTitle: 'Project Files - Explorer',
            folderTaskTitle: 'Project Files',
            folderAddress: 'C:\\GAVIN\\PROJECTS',
            folderAgent: 'AI Agent',
            folderVision: 'Computer Vision',
            folderRobotics: 'Robotics Systems',
            folderResearch: 'Research',
            folderMedia: 'Media',
            folderReadme: 'README.TXT',
            folderReadmeBody: 'Portfolio projects, research and visual assets.',
            folderStatus: '1 object',
            folderRoboMasterRecords: 'ROBOMASTER_RECORDS',
            folderRoboMasterRecordsBody: '13 match and tuning photos',
            folderPhotoWindowTitle: 'ROBOMASTER_RECORDS - Explorer',
            folderPhotoAddress: 'C:\\GAVIN\\PROJECTS\\ROBOMASTER_RECORDS',
            folderPhotoStatus: '13 objects',
            folderUp: 'Up one level',
            previewWindowTitle: 'Image Preview',
            previewTaskTitle: 'Image Preview',
            previewStatus: 'Select an image to preview',
            previewImageType: 'JPEG image',
            ...
            shutdownBrandName: 'Gavin,',
            shutdownBrandSubline: 'gavin inc.',
            shutdownRelease: 'GavinOS / Power Management',
            shutdownReleaseVersion: 'System Session 1.0',
            shutdownKicker: 'SYSTEM STATUS: SAFE SHUTDOWN',
            shutdownTitle: 'System is safely paused',
            shutdownRestart: 'Restart now',
            shutdownHint: 'Portfolio content remains online. Restart now or let the system restore automatically.',
            shutdownLines: [
                'Saving portfolio session...',
                'Closing the personal homepage window...',
                'Portfolio content remains online.',
                'GavinOS has entered a safe paused state.'
            ],
            ...
            publicationsKicker: 'Research',
            publicationsTitle: 'Research in progress',
            paperOneVenue: 'AAAI 2027 · CCF-A · Submitted · Jun 2026',
            paperOneRole: 'Co-first Author · Submission 3748',
            paperOneBody: 'Proposed a lag-robust spectral graph aggregation framework combining local patch representations, Top-k sparse adaptive graph aggregation and a spectral uncertainty loss.',
            ...
            educationHighlights: ['Two National Scholarships', 'Inspirational Role Model', 'Outstanding Graduate', 'First-class Scholarship', 'Annual Student Figure', 'Learning Pioneer'],
            contactKicker: 'Contact',
            ...
            projects: [
                ...
                },
                {
                    ...
                    role: 'Full-stack Developer / Project Lead',
                    period: '2023.09 - 2024.06',
                    body: 'An automated inventory loop connecting visual detection, LIVO localization and a web management platform.',
                    alt: 'Machine-vision and radar inventory sensors mounted on warehouse shelving',
                    details: [
            ...
            otherAwards: [
                ...
                '2026 TAAC Tencent Advertising Algorithm Competition, 114th place, Top 7%',
    ...
    window.PORTFOLIO_DATA = Object.freeze({ USER, SUPPORTED_LANGS, CONTENT });
})();
